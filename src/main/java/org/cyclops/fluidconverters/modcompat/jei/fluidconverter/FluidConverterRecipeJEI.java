...
public class FluidConverterRecipeJEI extends BlankRecipeWrapper {
    ...
    public FluidConverterRecipeJEI(FluidElement fluidInput, FluidElement fluidOutput, FluidGroup fluidGroup) {
      ...
      int outputAmount = MathHelper.floor_float(fluidOutput.denormalize((1 - fluidGroup.getLossRatio()) * fluidInput.normalize(inputAmount)));
...
*/
         ...
         String str = String.format("x%s",ratio);
          ...
          if (str != null) {
              ...
              lossTooltipArea = new Rectangle(x,y,minecraft.fontRendererObj.getStringWidth(str),minecraft.fontRendererObj.FONT_HEIGHT);
          }
    }
